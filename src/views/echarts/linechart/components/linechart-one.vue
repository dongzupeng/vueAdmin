<template>
    <div class="lineOne" ref="lineOne"></div>
</template>
...
export default {
    ...
    methods: {
        initEchart() {
            this.myChartOne = echarts.init(this.$refs.lineOne);
            var xData = (function () {
                var data = [];
                for (var i = 1; i < 31; i++) {
                    data.push(i + "日");
                    ...
                    series: [
                        {
                            ...
                            data: [
                                509, 917, 2455, 2610, 2719, 3033, 3044, 3085,
                                2708, 2809, 2117, 2000, 1455, 1210, 719, 733,
                                944, 2285, 2208, 3372, 3936, 3693, 2962, 2810,
